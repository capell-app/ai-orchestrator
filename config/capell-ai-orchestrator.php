...
return [
    ...
    'prompts' => [
        ...
        'meta_description' => [
            'system' => 'You are a helpful ai-orchestrator that writes accurate and engaging meta descriptions.',
            'user_template' => 'Write an SEO meta description (max 160 characters) for: {{content}}. Keywords: {{keywords}}.',
        ],
        'content_generation' => [
            'system' => 'You are a helpful ai-orchestrator that writes engaging, accessible, and SEO-friendly HTML page content. Prefer short paragraphs, meaningful headings (h2/h3), and occasional lists. Keep tone friendly and informative.',
...
PROMPT,
        ...
        'ai_creator_clarify' => [
            'system' => 'You are a friendly CMS ai-orchestrator helping a user build a page. Ask ONE short clarifying question to help you understand their intent better. Keep it concise. Do not ask about tone or brand — those are handled separately.',
