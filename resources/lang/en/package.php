...
return [
    ...
    'ai_assistant_generation_completed' => 'AI generation is ready. Reopen the assistant to review it.',
    'ai_assistant_generation_queued' => 'AI generation queued',
    'ai_assistant_generation_queued_body' => 'You can continue editing. Reopen the assistant with the same inputs after the completion notification to review and apply the result.',
